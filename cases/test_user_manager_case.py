...
class TestUserManagerCase(unittest.TestCase):
    ...
    def test01_add_user(self):
        ...
        password = "123456"
        # 调用接口
        result = self.api.add_manager(username,password)
    ...
    def test02_update_user(self):
        new_name = 'test9997'
        password = '123456'
        result = self.api.update_manager(TestUserManagerCase.user_id,new_name,password)
    ...
    def test04_delete_user(self):
        new_name = 'test9997'
        password = '123456'
        result = self.api.delete_manager(TestUserManagerCase.user_id,new_name,password)
